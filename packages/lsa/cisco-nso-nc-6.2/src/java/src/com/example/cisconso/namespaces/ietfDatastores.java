...
public class ietfDatastores extends ConfNamespace {
    public static final int hash = 933132697;
    public int hash() {
        return ietfDatastores.hash;
    }

    public static final String id = "_cisco-nso-nc-6.2:cisco-nso-nc-6.2#urn:ietf:params:xml:ns:yang:ietf-datastores";
    public String id() {
        return ietfDatastores.id;
    }

    public static final String uri = "_cisco-nso-nc-6.2:cisco-nso-nc-6.2#urn:ietf:params:xml:ns:yang:ietf-datastores";
    public String uri() {
