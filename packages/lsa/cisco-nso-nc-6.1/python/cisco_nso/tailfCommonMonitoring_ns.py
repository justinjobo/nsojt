...
class ns(object):
    ...
    id = "_cisco-nso-nc-6.1:cisco-nso-nc-6.1#http://tail-f.com/yang/common-monitoring"

    uri = "_cisco-nso-nc-6.1:cisco-nso-nc-6.1#http://tail-f.com/yang/common-monitoring"
