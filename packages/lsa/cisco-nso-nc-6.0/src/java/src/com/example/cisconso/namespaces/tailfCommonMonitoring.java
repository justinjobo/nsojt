...
public class tailfCommonMonitoring extends ConfNamespace {
    public static final int hash = 196642735;
    public int hash() {
        return tailfCommonMonitoring.hash;
    }

    public static final String id = "_cisco-nso-nc-6.0:cisco-nso-nc-6.0#http://tail-f.com/yang/common-monitoring";
    public String id() {
        return tailfCommonMonitoring.id;
    }

    public static final String uri = "_cisco-nso-nc-6.0:cisco-nso-nc-6.0#http://tail-f.com/yang/common-monitoring";
    public String uri() {
