...
class ns(object):
    ...
    id = "_cisco-nso-nc-6.0:cisco-nso-nc-6.0#http://tail-f.com/yang/common-monitoring"

    uri = "_cisco-nso-nc-6.0:cisco-nso-nc-6.0#http://tail-f.com/yang/common-monitoring"
