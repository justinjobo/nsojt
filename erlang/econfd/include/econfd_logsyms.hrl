...
-define( LOGSYM_SSH_HOST_KEY_UNAVAILABLE, 202).
%% 
%%
%% "Failed to load commit queue. NCS recovers by starting from an empty commit queue."
-define( LOGSYM_COMMIT_QUEUE_CORRUPT, 203).
%% 
%%
%% "A package authenticated user logged in."
-define( LOGSYM_NCS_PACKAGE_AUTH_SUCCESS, 204).
%% 
%%
%% "Package authentication failed."
-define( LOGSYM_NCS_PACKAGE_AUTH_FAIL, 205).
%% 
%%
%% "Package authentication program returned badly formatted data."
-define( LOGSYM_NCS_PACKAGE_AUTH_BAD_RET, 206).
%% 
%%
%% "Show if JIT is enabled."
-define( LOGSYM_JIT_ENABLED, 207).
%% 
%%
%% "Log message from NIF code."
-define( LOGSYM_NIF_LOG, 208).
%% 
%%
%% "maapi failed to write to a socket."
-define( LOGSYM_MAAPI_WRITE_TO_SOCKET_FAIL, 209).
%% 
%%
%% "Package authentication challenge sent to a user."
-define( LOGSYM_NCS_PACKAGE_CHAL_2FA, 210).
%% 
%%
%% "Package authentication challenge failed."
-define( LOGSYM_NCS_PACKAGE_CHAL_FAIL, 211).
