...
-define(ITER_WANT_LEAF_LIST_AS_LEAF,(1 bsl 9)). %% To be removed in ENG-20458
-define(ITER_WANT_CLI_ORDER,       (1 bsl 10)).
-define(ITER_WANT_SUPPRESS_OPER_DEFAULTS, (1 bsl 11)).
...
-define(CDB_READ_COMMITTED,      (1 bsl 4)).

-record(cdb_agent, {id :: pid()
                        | %% OTP registration support
                          {via, module(), atom()},
                    xds_ro = undefined :: undefined | xds:xds_ro()
                   }).
