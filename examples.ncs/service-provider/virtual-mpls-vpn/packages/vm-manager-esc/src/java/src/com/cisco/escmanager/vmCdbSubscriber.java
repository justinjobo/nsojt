...
import com.tailf.pkg.resourcemanager.*;
...
public class vmCdbSubscriber implements ApplicationComponent {
    ...
    private class ReqHandler implements Runnable {
        ...
        public void run() {
            ...
            int tHandle = 0;
            try {
                // Remove sleep when ENG-27981 has been resolved. In
                // short, this is required as the below transaction
                // gets started before the transaction caused the
                // subscriber to execute register itself in the
                // writeset making the below transaction check for
                // conflicts against the transaction that made it run
                // in the first place.
                Thread.sleep(2500);
