...
create(_Tctx, [ObjRef, refs, Key, server, servers, [?simple__ns_uri|dp]]) ->
    [Srv] = find_server(Key),
...
doremove(_Tctx, [ObjRef, refs, Key, server, servers, [?simple__ns_uri|dp]]) ->
    [Srv] = find_server(Key),
