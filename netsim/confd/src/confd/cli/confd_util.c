...
PWBUF_FUN(confd_get_pwnam, const char*, passwd, getpwnam_r, confd_xrealloc)
PWBUF_FUN(confd_get_pwuid, uid_t, passwd, getpwuid_r, confd_xrealloc)
PWBUF_FUN(confd_get_group, gid_t, group, getgrgid_r, confd_xrealloc)
PWBUF_FUN(confd_get_group_name, const char*, group, getgrnam_r, confd_xrealloc)
