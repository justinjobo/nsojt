/*
 * ©2015-2023 Cisco Systems, Inc. and/or its affiliates. All rights reserved.
 *
...
"Consult the /rollback-files list instead.\n\n"
...
"This function is deprecated and will be removed in a future release.\n"
"Use the action /rollback-files/apply-rollback-file instead.\n\n"
