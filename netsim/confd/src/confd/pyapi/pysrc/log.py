...
class Log(object):
    ...
    def __init__(self, logobject, add_timestamp=False):
        ...
        self._exc = getattr(logobject, 'exception', None)
    ...
    def exception(self, *args):
        ...
        return self._do_log(self._exc, _join_args(*args))
...
class _Test(unittest.TestCase):
    ...
    def test_log_init_something(self):
        ...
        self.assertEqual(log._exc, mylog.exception)
    ...
    def test_log_all(self):
        ...
        self.assertEqual('ERROR: 1+2=3', log.exception(1, '+', 2, '=', 3))
