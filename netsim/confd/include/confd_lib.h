 ...
 * Copyright 2015-2023 Cisco Systems, Inc. and/or its affiliates.
 * All rights reserved.
 */
...
#define CONFD_LIB_VSN           0x08020500
#define CONFD_LIB_VSN_STR       "08020500"
#define CONFD_LIB_API_VSN       0x08020300
#define CONFD_LIB_API_VSN_STR   "08020300"
#define CONFD_LIB_PROTO_VSN     82
#define CONFD_LIB_PROTO_VSN_STR "82"
...
enum confd_iter_flags {     /* bitmask */
    ...
    ITER_WANT_SUPPRESS_OPER_DEFAULTS = (1<<11) /* cdb_diff_iterate() only */
};
...
#define MAX_SPAN_ID_LEN 17
#define MAX_TRACE_ID_LEN 65

/* a link to another progress event or maapi_progress_span*() calls */
struct confd_progress_link {
    char trace_id[MAX_TRACE_ID_LEN];
    char span_id[MAX_SPAN_ID_LEN];
};

typedef struct confd_progress_link confd_progress_span;
...
extern struct confd_cs_node *confd_find_cs_root(u_int32_t ns);
...
struct confd_ha_node {
    ...
    char addr_buf[128];   /* similar to the above, but for the address     */
                          ...
                          /* (from getpeeraddr() callback for secondary    */
                          /* nodes)                                        */
};
...
#define CONFD_ERR_HA_BADCONFIG              69

/* transaction conflict */
#define CONFD_ERR_TRANSACTION_CONFLICT      70

/* transaction aborted during transition */
#define CONFD_ERR_HA_ABORT                  71
#ifdef __cplusplus
}
#endif
#endif
