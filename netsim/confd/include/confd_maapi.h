...
#define MAAPI_FLAG_NO_CONFIG_CACHE   (1 << 4)
/* maapi_start_trans_flags() only */
#define MAAPI_FLAG_CONFIG_CACHE_ONLY (1 << 5)
...
/* Deprecated function - use maapi_progress_info() instead */
...
/* Deprecated function - use maapi_start_progress_span() instead */
...
/* Deprecated function - use maapi_end_progress_span() instead */
...
extern int maapi_start_progress_span(int sock,
    confd_progress_span *result,
    const char *msg,
    enum confd_progress_verbosity verbosity,
    const struct ncs_name_value *attrs, int num_attrs,
    const struct confd_progress_link *links, int num_links,
    char *path_fmt, ...);

extern int maapi_start_progress_span_th(int sock, int thandle,
    confd_progress_span *result,
    const char *msg,
    enum confd_progress_verbosity verbosity,
    const struct ncs_name_value *attrs, int num_attrs,
...
extern int maapi_progress_info(int sock,
    const char *msg,
    enum confd_progress_verbosity verbosity,
    const struct ncs_name_value *attrs, int num_attrs,
    const struct confd_progress_link *links, int num_links,
...
extern int maapi_progress_info_th(int sock, int thandle,
    const char *msg,
    enum confd_progress_verbosity verbosity,
    const struct ncs_name_value *attrs, int num_attrs,
    const struct confd_progress_link *links, int num_links,
...
extern int maapi_end_progress_span(int sock,
    const confd_progress_span *span, const char *annotation);
...
/* Deprecated - use action /rollback-files/apply-rollback-file instead */
