...
/* ************************************************************************ */
/* struct confd_progress_link -> confd._lib.ProgressLink                    */
/* ************************************************************************ */
...
extern PyObject* newConfdProgressLink(struct confd_progress_link *link);
extern int isConfdProgressLink(PyObject *o);
